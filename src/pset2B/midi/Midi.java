...
public class Midi {
    ...
    private final Map<pset2B.midi.Instrument, MidiChannel> channels = new HashMap<pset2B.midi.Instrument,MidiChannel>();
     ...
     */
    public void play(int note, int duration, pset2B.midi.Instrument instr) {
     ...
     * @param instr: instrument in midi.Instrument enum.
     */
    public void beginNote(int note, pset2B.midi.Instrument instr) {
        MidiChannel channel = getChannel(instr);
        synchronized (channel) {
            channel.noteOn(note, VELOCITY);
        }
     ...
     * @param instr: instrument in midi.Instrument enum.
     */
    public void endNote(int note, pset2B.midi.Instrument instr) {
        MidiChannel channel = getChannel(instr);
        synchronized (channel) {
     ...
     */
    private void log(int note, pset2B.midi.Instrument instr, boolean isNoteOn) {
     ...
     * modifies this
     */
    private MidiChannel getChannel(pset2B.midi.Instrument instr) {
     ...
     * @param instr
     */
    private void patchInstrumentIntoChannel(MidiChannel channel, pset2B.midi.Instrument instr) {
